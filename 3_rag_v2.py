...
#all the components that are not traced are written as functions and a decorator @traceable is used .
#If we do these thing two traceable parts are created in the langsmith website one for the components where @traceable is used and the other where chain starts. So this also a problem .
#@traceable(name="load_pdf",metadata=.. , tags = ..) metadata , tags can be added .
